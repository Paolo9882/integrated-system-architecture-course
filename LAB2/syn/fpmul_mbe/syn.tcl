...
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/$ENTITY_NAME.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/fpmul_stage1_struct.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/fpmul_stage2_struct.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/fpmul_stage3_struct.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/fpmul_stage4_struct.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/bru.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/dadda_tree.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/full_adder.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/half_adder.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/pp_generation.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/rca.vhd
analyze -f vhdl -lib WORK ../../src/fpmul_mbe/mbe_mult.vhd
