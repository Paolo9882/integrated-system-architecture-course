# Backannotation Modelsim script (for Innovus netlist)
...
vlog -work ./work ../netlist/$VERSION_FOLDER/${ENTITY_NAME}_inn.v
...
vsim -L /software/dk/nangate45/verilog/msim6.2g -sdftyp /$TB_NAME/DUT=../netlist/$VERSION_FOLDER/${ENTITY_NAME}_inn.sdf work.$TB_NAME

# Create VCD file (value-change-dump: records switching activity)
vcd file ../vcd/$VERSION_FOLDER/${ENTITY_NAME}_inn.vcd
